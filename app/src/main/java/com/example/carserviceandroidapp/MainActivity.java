...
public class MainActivity extends AppCompatActivity {
    DBHelper DB;
int userID= 2; //testing when userID is 2
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button button2  = findViewById(R.id.btnInsertDummyData);
        Button button3 = findViewById(R.id.btnFindServiceShop);
        ...
        DB = new DBHelper(this);
         ...
         button3.setOnClickListener(new View.OnClickListener() {
             ...
             public void onClick(View v) {
                 ...
                 startActivity(new Intent(MainActivity.this, CustomerFindServiceProviderLocation.class));
             }
         });
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editor.commit();
               startActivity(new Intent(MainActivity.this,CustomerEditProfile.class));
            }
        });
    }
}