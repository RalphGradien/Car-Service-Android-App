...
public class CustomerEditProfile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EditText editTxtUserName = findViewById(R.id.editProviderName);
        EditText editTxtEmail = findViewById(R.id.ProviderEmail);
        EditText editTxtPassword = findViewById(R.id.editProviderPassword);
        EditText editTxtConfirmPassword = findViewById(R.id.editProviderCity);
        EditText editTxtMobile = findViewById(R.id.editProviderContact);
        EditText editTxtAddress = findViewById(R.id.editProviderAddress);
